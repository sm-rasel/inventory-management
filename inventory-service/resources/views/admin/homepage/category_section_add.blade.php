    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.category_store') }}" method="POST" id="" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="c_name" id="" placeholder="Enter Category Name"/>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" name="c_qty" id="" placeholder="Enter Quantity"/>
                            @if($errors->has('c_qty'))
                                <span class="error" id="">{{ $errors->first('c_qty') }}</span>
                            @endif
                        </div>
                    </div>
                    <div class="row justify-content-end">
                        <div class="col-sm-9">
                            <button type="submit" class="btn btn-outline-success w-md px-5 me-1" id="">Create New
                                Category
                            </button>
