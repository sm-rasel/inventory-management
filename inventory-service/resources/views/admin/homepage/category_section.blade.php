...
@section('main_content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Item Area</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Item Area</a></li>
                        <li class="breadcrumb-item active">Item Section</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3 mb-md-5">Item Section
                        <button class="btn btn-sm btn-outline-success w-md float-end"
                                onclick="window.location.href='{{ route('admin.category_add') }}'">
